...
type FakeK8s struct {
	ApplyStub        func(func(io.Writer) error, *chart.K8sOptions) error
	applyMutex       sync.RWMutex
	applyArgsForCall []struct {
		arg1 func(io.Writer) error
		arg2 *chart.K8sOptions
	}
	applyReturns struct {
		result1 error
	}
	...
	DeleteStub        func(func(io.Writer) error, *chart.K8sOptions) error
	...
	DeleteObjectStub        func(string, string, *chart.K8sOptions) error
	deleteObjectMutex       sync.RWMutex
	deleteObjectArgsForCall []struct {
		arg1 string
		arg2 string
		arg3 *chart.K8sOptions
	}
	...
	ForNamespaceStub        func(string) chart.K8s
	...
	GetStub        func(string, string, io.Writer, *chart.K8sOptions) error
	getMutex       sync.RWMutex
	getArgsForCall []struct {
		arg1 string
		arg2 string
		arg3 io.Writer
		arg4 *chart.K8sOptions
	}
	getReturns struct {
		result1 error
	}
	...
	RolloutStatusStub        func(string, string, *chart.K8sOptions) error
...
func (fake *FakeK8s) Apply(arg1 func(io.Writer) error, arg2 *chart.K8sOptions) error {
...
func (fake *FakeK8s) ApplyCalls(stub func(func(io.Writer) error, *chart.K8sOptions) error) {
	fake.applyMutex.Lock()
	defer fake.applyMutex.Unlock()
	fake.ApplyStub = stub
}

func (fake *FakeK8s) ApplyArgsForCall(i int) (func(io.Writer) error, *chart.K8sOptions) {
	fake.applyMutex.RLock()
	defer fake.applyMutex.RUnlock()
...
func (fake *FakeK8s) Delete(arg1 func(io.Writer) error, arg2 *chart.K8sOptions) error {
...
func (fake *FakeK8s) DeleteCalls(stub func(func(io.Writer) error, *chart.K8sOptions) error) {
	fake.deleteMutex.Lock()
	defer fake.deleteMutex.Unlock()
	fake.DeleteStub = stub
}

func (fake *FakeK8s) DeleteArgsForCall(i int) (func(io.Writer) error, *chart.K8sOptions) {
	fake.deleteMutex.RLock()
	defer fake.deleteMutex.RUnlock()
...
func (fake *FakeK8s) DeleteObject(arg1 string, arg2 string, arg3 *chart.K8sOptions) error {
...
func (fake *FakeK8s) DeleteObjectCalls(stub func(string, string, *chart.K8sOptions) error) {
	fake.deleteObjectMutex.Lock()
	defer fake.deleteObjectMutex.Unlock()
	fake.DeleteObjectStub = stub
}

func (fake *FakeK8s) DeleteObjectArgsForCall(i int) (string, string, *chart.K8sOptions) {
	fake.deleteObjectMutex.RLock()
	defer fake.deleteObjectMutex.RUnlock()
...
func (fake *FakeK8s) ForNamespace(arg1 string) chart.K8s {
...
func (fake *FakeK8s) ForNamespaceCalls(stub func(string) chart.K8s) {
	fake.forNamespaceMutex.Lock()
...
func (fake *FakeK8s) ForNamespaceReturns(result1 chart.K8s) {
	fake.forNamespaceMutex.Lock()
	defer fake.forNamespaceMutex.Unlock()
...
func (fake *FakeK8s) ForNamespaceReturnsOnCall(i int, result1 chart.K8s) {
	fake.forNamespaceMutex.Lock()
	defer fake.forNamespaceMutex.Unlock()
	fake.ForNamespaceStub = nil
...
func (fake *FakeK8s) Get(arg1 string, arg2 string, arg3 io.Writer, arg4 *chart.K8sOptions) error {
	fake.getMutex.Lock()
...
func (fake *FakeK8s) GetCalls(stub func(string, string, io.Writer, *chart.K8sOptions) error) {
	fake.getMutex.Lock()
	defer fake.getMutex.Unlock()
	fake.GetStub = stub
}

func (fake *FakeK8s) GetArgsForCall(i int) (string, string, io.Writer, *chart.K8sOptions) {
	fake.getMutex.RLock()
	defer fake.getMutex.RUnlock()
...
func (fake *FakeK8s) RolloutStatus(arg1 string, arg2 string, arg3 *chart.K8sOptions) error {
...
func (fake *FakeK8s) RolloutStatusCalls(stub func(string, string, *chart.K8sOptions) error) {
	fake.rolloutStatusMutex.Lock()
	defer fake.rolloutStatusMutex.Unlock()
	fake.RolloutStatusStub = stub
}

func (fake *FakeK8s) RolloutStatusArgsForCall(i int) (string, string, *chart.K8sOptions) {
	fake.rolloutStatusMutex.RLock()
	defer fake.rolloutStatusMutex.RUnlock()

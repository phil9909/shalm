...
type FakeK8s struct {
	ApplyStub        func(func(io.Writer) error, *shalm.K8sOptions) error
	...
	DeleteStub        func(func(io.Writer) error, *shalm.K8sOptions) error
	...
	ForNamespaceStub        func(string) shalm.K8s
	...
	GetStub        func(string, string, io.Writer, *shalm.K8sOptions) error
	...
	WatchStub        func(string, string, *shalm.K8sOptions) (io.ReadCloser, error)
...
func (fake *FakeK8s) Apply(arg1 func(io.Writer) error, arg2 *shalm.K8sOptions) error {
...
func (fake *FakeK8s) ApplyCalls(stub func(func(io.Writer) error, *shalm.K8sOptions) error) {
	fake.applyMutex.Lock()
	defer fake.applyMutex.Unlock()
	fake.ApplyStub = stub
}

func (fake *FakeK8s) ApplyArgsForCall(i int) (func(io.Writer) error, *shalm.K8sOptions) {
	fake.applyMutex.RLock()
	defer fake.applyMutex.RUnlock()
...
func (fake *FakeK8s) Delete(arg1 func(io.Writer) error, arg2 *shalm.K8sOptions) error {
...
func (fake *FakeK8s) DeleteCalls(stub func(func(io.Writer) error, *shalm.K8sOptions) error) {
	fake.deleteMutex.Lock()
	defer fake.deleteMutex.Unlock()
	fake.DeleteStub = stub
}

func (fake *FakeK8s) DeleteArgsForCall(i int) (func(io.Writer) error, *shalm.K8sOptions) {
	fake.deleteMutex.RLock()
	defer fake.deleteMutex.RUnlock()
...
func (fake *FakeK8s) ForNamespace(arg1 string) shalm.K8s {
...
func (fake *FakeK8s) ForNamespaceCalls(stub func(string) shalm.K8s) {
	fake.forNamespaceMutex.Lock()
...
func (fake *FakeK8s) ForNamespaceReturns(result1 shalm.K8s) {
	fake.forNamespaceMutex.Lock()
	defer fake.forNamespaceMutex.Unlock()
...
func (fake *FakeK8s) ForNamespaceReturnsOnCall(i int, result1 shalm.K8s) {
	fake.forNamespaceMutex.Lock()
	defer fake.forNamespaceMutex.Unlock()
	fake.ForNamespaceStub = nil
...
func (fake *FakeK8s) Get(arg1 string, arg2 string, arg3 io.Writer, arg4 *shalm.K8sOptions) error {
	fake.getMutex.Lock()
...
func (fake *FakeK8s) GetCalls(stub func(string, string, io.Writer, *shalm.K8sOptions) error) {
	fake.getMutex.Lock()
	defer fake.getMutex.Unlock()
	fake.GetStub = stub
}

func (fake *FakeK8s) GetArgsForCall(i int) (string, string, io.Writer, *shalm.K8sOptions) {
	fake.getMutex.RLock()
	defer fake.getMutex.RUnlock()
...
func (fake *FakeK8s) Watch(arg1 string, arg2 string, arg3 *shalm.K8sOptions) (io.ReadCloser, error) {
...
func (fake *FakeK8s) WatchCalls(stub func(string, string, *shalm.K8sOptions) (io.ReadCloser, error)) {
	fake.watchMutex.Lock()
